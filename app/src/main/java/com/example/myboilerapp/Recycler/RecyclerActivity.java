...
import com.example.myboilerapp.databinding.ActivityRecyclerBinding;
...
public class RecyclerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mModel = ViewModelProviders.of(this,new RecyclerViewModelFactory(this.getApplication())).get(RecyclerViewModel.class);
    ...
    private void initImageBitmaps(){
        Log.i(TAG, "initImageBitmaps: called.");
    ...
    private void initRecyclerView(){
        ...
        ListAdapter recyclerViewAdapter = new ListAdapter(this,mNames,mImageUrls);
